...
Integer __attribute__((noinline)) easyCustomRangeLoop(Integer max) {
  struct CustomRangeIterator : public easy_iterator::InitializedIterable {
    ...
    CustomRangeIterator(Integer start, Integer end, Integer increment)
        : current(start), max(end - ((end - start) % increment)), step(increment) {}
...
easyZipIteration(const std::vector<int> &integers, const std::vector<double> &doubles) {
...
void __attribute__((noinline))
iterZipIteration(const std::vector<int> &integers, const std::vector<double> &doubles) {
...
void __attribute__((noinline))
stdZipIteration(const std::vector<int> &integers, const std::vector<double> &doubles) {
